...
#define STRING_CONFIG_H_AUTHOR "(SKGO2, Steven)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SKGO2"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 137.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 24.35, 2.3, 0 }
...
//
// #define REVERSE_MENU_DIRECTION // for reprap red lcd
